...
class Setting extends BaseController
{
    ...
    public function detail()
    {
        ...
        return $this->renderSuccess([
            ...
            'openclaw_base_url'        => $s['openclaw_base_url'] ?? env('openclaw.base_url', 'http://127.0.0.1:18789'),
            'openclaw_agent_id'        => $s['openclaw_agent_id'] ?? 'main',
            'ai_api_url'               => $s['ai_api_url'] ?? env('ai.api_url', 'https://api.deepseek.com/v1/chat/completions'),
